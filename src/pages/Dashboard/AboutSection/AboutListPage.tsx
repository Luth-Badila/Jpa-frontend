...
import { getAbouts, deleteAbout } from "../../../api/about";
  ...
  return (
    <DashboardLayout>
      <div className="flex items-center justify-between mb-6">
        ...
        <div>
          <button onClick={() => navigate("/dashboard-about/new")} className="px-4 py-2 bg-blue-600 text-white rounded cursor-pointer">
            Create
          </button>
        </div>
      </div>
              ...
              data.map((item) => (
                <tr key={item.id} className="border-t">
                  ...
                  <td className="p-3">
                    ...
                    <button
                      onClick={() => navigate(`/dashboard-about/${item.id}/edit`)}
                      className="mr-2 text-white cursor-pointer 
