...
export default function ImageEditor() {
    ...
    return (_jsxs("div", { className: "flex flex-col items-center space-y-4", children: [_jsxs("label", { className: "cursor-pointer bg-green-500 text-white px-4 py-2 rounded", children: ["Upload Background", _jsx("input", { type: "file", accept: "image/*", className: "hidden", onChange: handleBackgroundUpload })] }), _jsxs("label", { className: "cursor-pointer bg-green-500 text-white px-4 py-2 rounded", children: ["Upload Overlay", _jsx("input", { type: "file", accept: "image/*", className: "hidden", onChange: handleOverlayUpload })] }), _jsxs("div", { ref: containerRef, className: "relative border w-[600px] h-[400px] bg-gray-200", children: [background && _jsx("img", { src: background, alt: "bg", className: "absolute inset-0 w-full h-full object-cover" }), overlay && (_jsx(motion.img, { src: overlay, alt: "overlay", drag: true, dragMomentum: false, className: "absolute w-32 h-32 cursor-move", style: { left: overlayPos.x, top: overlayPos.y }, onDragEnd: (_, info) => {
                        ...
                        } }))] }), _jsx("canvas", { ref: canvasRef, className: "hidden" }), _jsx("button", { onClick: handleSave, className: "px-4 py-2 bg-green-500 text-white rounded cursor-pointer", children: "Simpan ke Supabase" })] }));
}
